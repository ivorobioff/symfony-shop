...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('FoggylineCatalogBundle:category:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('FoggylineCatalogBundle:category:new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Category $category)
    {
        ...
        return $this->render('FoggylineCatalogBundle:category:show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        return $this->render('FoggylineCatalogBundle:category:edit.html.twig', array(
            'category' => $category,
